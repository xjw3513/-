...
c3 = (
    ...
    .set_global_opts(title_opts=opts.TitleOpts(title="各个省市招聘人数"),xaxis_opts=opts.AxisOpts(name="省份",axislabel_opts={"rotate":45}),datazoom_opts=[opts.DataZoomOpts()])
    .set_series_opts(
...
c3 .render('可视化/各个省市招聘人数条形图.html')
c3 .render_notebook()